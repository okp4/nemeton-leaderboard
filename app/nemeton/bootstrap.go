...
Share the content links to botanik#4248 on Discord. Only one submission per druid will be studied.`,
		...
		},
		{
			...
			Name:        "Lughnasad",
			Description: "",
			StartDate:   time.Date(2023, time.March, 1, 0, 0, 0, 0, time.UTC),
			EndDate:     time.Date(2023, time.April, 13, 23, 59, 59, 0, time.UTC),
			Tasks: []Task{
				makeVoteProposalTask(
					"0",
					"Governance vote to reduce governance voting period",
					"",
					time.Date(2023, time.March, 1, 12, 0, 0, 0, time.UTC),
					time.Date(2023, time.March, 15, 12, 0, 0, 0, time.UTC),
					1000,
					3,
				),
				makeVoteProposalTask(
					"1",
					"Governance vote to perform a chain upgrade",
					"",
					time.Date(2023, time.March, 16, 12, 0, 0, 0, time.UTC),
					time.Date(2023, time.March, 17, 12, 0, 0, 0, time.UTC),
					1000,
					4,
				),
				makeUpgradeTask(
					...
					"Upgrade your node on time",
					"",
					time.Date(2023, time.March, 20, 12, 0, 0, 0, time.UTC),
					time.Date(2023, time.April, 13, 23, 59, 59, 0, time.UTC),
					2500,
					1453125,
					1453750,
				),
				...
				makeSubmissionTask(
					"4",
					"Give us Feedback on gas consumption",
					"",
					time.Date(2023, time.March, 1, 0, 0, 0, 0, time.UTC),
					time.Date(2023, time.April, 13, 23, 59, 59, 0, time.UTC),
				),
				makeSubmissionTask(
					"5",
					"Identify Failures in the Logic module",
					"",
					time.Date(2023, time.March, 1, 0, 0, 0, 0, time.UTC),
					time.Date(2023, time.April, 13, 23, 59, 59, 0, time.UTC),
				),
